    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-6 py-12 bg-gray-50 dark:bg-[#0f0f0f]">
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-[#2a2a2a] p-8">
          ...
          <h2 className="text-center mb-2 text-gray-900 dark:text-white">Criar Conta</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              <input
                ...
                className="w-4 h-4 mt-1 text-[#FF6B35] dark:text-[#ff7043] border-gray-300 dark:border-[#2a2a2a] rounded focus:ring-[#FF6B35] dark:focus:ring-[#ff7043]"
              />
              <label htmlFor="terms" className="text-gray-600 dark:text-gray-400" style={{ fontSize: '14px' }}>
                Eu aceito os{" "}
                <Link to="/termos" className="text-[#FF6B35] dark:text-[#ff7043] hover:underline">
                  termos e condições
                </Link>{" "}
                e a{" "}
                <Link to="/privacidade" className="text-[#FF6B35] dark:text-[#ff7043] hover:underline">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 dark:text-gray-400">
              Já tem uma conta?{" "}
              <Link to="/login" className="text-[#FF6B35] dark:text-[#ff7043] hover:underline transition-colors duration-300">
                Faça login
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 dark:border-[#2a2a2a] rounded-xl hover:bg-gray-50 dark:hover:bg-[#2a2a2a] transition-all duration-300"
            >
